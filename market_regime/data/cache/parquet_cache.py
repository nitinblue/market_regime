...
from market_regime.data.exceptions import CacheError
from market_regime.models.data import CacheMeta, DataType


class ParquetCache:
    """Manages parquet files in ~/.market_regime/cache/."""
    ...
    def __init__(self, cache_dir: Path | None = None, staleness_hours: float | None = None) -> None:
        ...
        self.cache_dir = cache_dir or Path.home() / ".market_regime" / "cache"
